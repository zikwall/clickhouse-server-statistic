...
class Bootstrap implements BootstrapInterface
{
    public function bootstrap($app)
    {
        $app->urlManager->addRules([
            ...
            ['pattern' => 'api/v1/general/get-channels-view-duration-with-channels-id', 'route' => 'rest/channels/channels/get-channels-view-duration-with-channels-id', 'verb' => ['POST', 'OPTIONS']],
